...
A imagem representa o coeficiente da rede. Ao multiplicarmos pela entrada, teremos o logaritmo da probabilidade da amostra pertencer à classe sobre a probabilidade
dela pertencer à classe de referência. A imagem mostrada é a resposta do modelo a uma matriz de 1's. Isso pode ser interpretado como a contribuição de cada pixel
para a probabilidade final. A interpretação de cada classe começa a ser perdida mas ainda é possível reconhecer vagamente os contornos dos dígitos.
\newpage
...
\begin{figure}[H]
    \centering
    \includegraphics{../figures/3/neural_network_input_hidden_weights.png}
