...
Dos três modelos analisados, o erro de teste da Regressão Linear foi o menor. Mesmo com a divisão em k-folds, aparentemente houve overfitting na regressão Ridge com Kernel, já que seu erro de treino é consideravelmente menor que o erro de teste e o erro de treino é o menor dentre os demais modelos. Este comportamento não é anormal, dado que estamos projetando os dados em um espaço vetorial de maior dimensão. Já a regressão ridge teve o pior dentre os erros de treino, o que é esperado dada a restrição introduzida pelo método. Seu erro de teste foi maior que o do regressor linear, o que também não é anormal.