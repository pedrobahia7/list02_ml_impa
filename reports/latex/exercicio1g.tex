\subsection*{Item g}
\addcontentsline{toc}{subsection}{Item g}
...
O melhor valor de $\alpha$ encontrado foi \textbf{123.28467394420659}. Com ele, obteve-se os seguintes erros médios
quadráticos:
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|}
        \hline
        Conjunto             & Erro médio quadrático       \\ \hline
        Validação (10 folds) & \textbf{21.435531198668574} \\
        Teste                & \textbf{16.146896300698355} \\
        Treino               & \textbf{18.529265711031723} \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|}
        ...
        $\alpha$       & \textbf{0.03593813663804626} \\
        $\gamma$       & \textbf{0.001}               \\
        kernel         & \textbf{laplacian}           \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|}
        \hline
        Conjunto             & Erro médio quadrático       \\ \hline
        Validação (10 folds) & \textbf{20.654538652474056} \\
        Teste                & \textbf{17.02053852320954}  \\
        Treino               & \textbf{8.510986395703279}  \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|}
        ...
        Regressão linear           & \textbf{18.090133641655044} \\
        Regressão ridge            & \textbf{18.529265711031723} \\
        Regressão ridge com kernel & \textbf{8.510986395703279}  \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|}
        \hline
        Modelo                     & Erro médio quadrático       \\ \hline
        Regressão linear           & \textbf{15.910489104854445} \\
        Regressão ridge            & \textbf{16.146896300698355} \\
        Regressão ridge com kernel & \textbf{17.02053852320954}  \\
        \hline
    \end{tabular}
    \caption{Resultados de teste}
\end{table}

Dos três modelos analisados, o erro de teste da Regressão Linear foi o menor. Mesmo com a divisão em k-folds, aparentemente houve overfitting na
regressão Ridge com Kernel, já que seu erro de treino é consideravelmente menor que o erro de teste e o erro de treino é o menor dentre os demais modelos.
Este comportamento não é anormal, dado que estamos projetando os dados em um espaço vetorial de maior dimensão. Já a regressão ridge teve o pior dentre os
erros de treino, o que é esperado dada a restrição introduzida pelo método. Seu erro de teste foi maior que o do regressor linear, o que também não é anormal.