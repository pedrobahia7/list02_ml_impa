...
apenas para os pontos onde a restrição de margem é ativa, ou seja, em pontos dentro
da margem ou incorretamente classificados (os vetores de suporte). Para todas as outras
