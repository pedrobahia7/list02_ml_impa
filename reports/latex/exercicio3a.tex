...
Os modelos com a melhor acurácia foram \textbf{SVM (98.2\%), Rede Neural (97.6\%) e kNN (96.9\%)}. O modelo mais rápido para treinar foi o \textbf{kNN (0.249s)}, enquanto o mais rápido para testar foi a \textbf{Regressão Logística (0.038s)}. Isso indica que modelos mais simples como kNN são eficientes no treinamento, mas podem ser lentos na predição devido à busca pelos vizinhos mais próximos. Por outro lado, modelos como SVM alcançam alta acurácia, mas requerem tempo computacional significativo tanto para treinamento quanto para predição.
